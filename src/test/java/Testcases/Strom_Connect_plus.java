...
public class Strom_Connect_plus extends Base {
	@Test(priority = 1)
	public void Watch_Connection() throws InterruptedException {
		pairing("Storm Connect Plus", "SCONNECTPLUS_05AD");
	}

	@Test(priority = 2)
	public void Home_dasboard_components_Check() {
		ULC2BT_Home_dasboard_components_Check("Storm Connect Plus");
	}
	@Test(priority = 3)
	public void Watch_features_Check() throws InterruptedException {
	   Sconnectplus_Settings_Features_Display_Check();
	}
	...
	@Test(priority = 6)
	public void Auto_spo2() throws InterruptedException {
		Auto_SPO2_feature();
	}
	
	@Test(priority = 7)
	public void Auto_stress() throws InterruptedException{
		Auto_Stress_feature();
	}
	...
	@Test(priority = 11)
	public void Event_reminder() throws InterruptedException{
		event_reminder_feature();
	...
	public void Find_my_watch(){
		Sconnect_Find_my_watch_feature();
	...
	@Test(priority = 17)
	public void Sports_type() throws InterruptedException{
		Sports_type_feature();
	}
